...
public class NewsController {
     ...
     * 最新新闻列表查询接口
     */
    @Operation(summary = "最新新闻查询接口")
    @GetMapping("lastest_list")
    public RestResp<List<NewsInfoRespDto>> listLatestNews() {
        return newsService.listLatestNews();
    }

    @Operation(summary = "新闻信息查询")
    @GetMapping("{id}")
    public RestResp<NewsInfoRespDto> getNewsInfoById(@Parameter(description = "新闻Id") @PathVariable(value = "id") Long newsId) {
